export const TASK_FALLBACK: Record<string, { name: string; category: string }> =
  {
    task_00_sanity: { name: "Sanity Check", category: "basic" },
    task_01_calendar: { name: "Calendar Event", category: "calendar" },
    task_02_stock: { name: "Stock Research", category: "research" },
    ...
    task_09_files: { name: "File Operations", category: "file_ops" },
